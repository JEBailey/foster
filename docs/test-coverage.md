...
| Bytecode compiler, optimizer, verifier, VM, and binary format | Every Foster suite runs optimized and unoptimized bytecode | IR lowering, malformed programs, deterministic encoding, optimizer reductions, and semantic equivalence |
