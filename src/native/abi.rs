...
pub const ALLOC: &str = "foster_rt_v1_alloc";
pub const DEALLOC: &str = "foster_rt_v1_dealloc";
pub const ASSERT: &str = "foster_rt_v1_assert";
pub const FAIL: &str = "foster_rt_v1_fail";

pub const STRING_CONSTANT: &str = "foster_rt_v1_string_constant";
pub const ARGS_EXECUTABLE: &str = "foster_rt_v1_args_executable";
pub const ARGS_VALUES: &str = "foster_rt_v1_args_values";
pub const STRING_LIST_EMPTY: &str = "foster_rt_v1_string_list_empty";
pub const STRING_LIST_LENGTH: &str = "foster_rt_v1_string_list_length";
pub const STRING_LIST_GET: &str = "foster_rt_v1_string_list_get";
pub const STRING_LIST_HEAD: &str = "foster_rt_v1_string_list_head";
pub const STRING_EMPTY: &str = "foster_rt_v1_string_empty";
pub const STRING_LENGTH: &str = "foster_rt_v1_string_length";
pub const STRING_HEAD: &str = "foster_rt_v1_string_head";
pub const STRING_REST: &str = "foster_rt_v1_string_rest";
pub const STRING_WHITESPACE: &str = "foster_rt_v1_string_whitespace";
pub const STRING_CONCAT: &str = "foster_rt_v1_string_concat";
pub const STRING_BYTE_LENGTH: &str = "foster_rt_v1_string_byte_length";
pub const STRING_COPY_BYTES: &str = "foster_rt_v1_string_copy_bytes";
pub const STRING_FROM_UTF8: &str = "foster_rt_v1_string_from_utf8";
pub const STRING_GET: &str = "foster_rt_v1_string_get";
pub const STRING_EQUAL: &str = "foster_rt_v1_string_equal";
pub const OBJECT_EQUAL: &str = "foster_rt_v1_object_equal";
pub const COPY_BYTES: &str = "foster_rt_v1_copy_bytes";
pub const CODE_POINT_WHITESPACE: &str = "foster_rt_v1_code_point_whitespace";
pub const CODE_POINT_STRING: &str = "foster_rt_v1_code_point_string";
pub const PARSE_FLOAT: &str = "foster_rt_v1_parse_float";
pub const FORMAT_FLOAT: &str = "foster_rt_v1_format_float";
...
pub const HOST_CALL_NULLARY: &str = "foster_rt_v1_host_call_nullary";
pub const HOST_CALL_STRING: &str = "foster_rt_v1_host_call_string";
pub const HOST_CALL_STRINGS: &str = "foster_rt_v1_host_call_strings";
pub const HOST_CALL_STRING_INTS: &str = "foster_rt_v1_host_call_string_ints";
pub const HOST_CALL_INT: &str = "foster_rt_v1_host_call_int";
pub const HOST_CALL_INTS: &str = "foster_rt_v1_host_call_ints";
pub const HOST_CALL_STRING_BYTES: &str = "foster_rt_v1_host_call_string_bytes";
pub const HOST_CALL_INT_BYTES: &str = "foster_rt_v1_host_call_int_bytes";
pub const HOST_CALL_INT_STRING: &str = "foster_rt_v1_host_call_int_string";
pub const HOST_REQUIRE_OK: &str = "foster_rt_v1_host_require_ok";
pub const HOST_OK: &str = "foster_rt_v1_host_ok";
pub const HOST_INTEGER: &str = "foster_rt_v1_host_integer";
pub const HOST_ERROR_VALUE: &str = "foster_rt_v1_host_error_value";
pub const HOST_STRING: &str = "foster_rt_v1_host_string";
pub const HOST_BYTES_LENGTH: &str = "foster_rt_v1_host_bytes_length";
pub const HOST_COPY_BYTES: &str = "foster_rt_v1_host_copy_bytes";
pub const HOST_STRINGS_LENGTH: &str = "foster_rt_v1_host_strings_length";
pub const HOST_RELEASE: &str = "foster_rt_v1_host_release";
...
pub const REMOTE_SPAWN: &str = "foster_rt_v1_remote_spawn";
pub const REMOTE_CALL: &str = "foster_rt_v1_remote_call";
pub const FUTURE_AWAIT: &str = "foster_rt_v1_future_await";
pub const REMOTE_RELEASE: &str = "foster_rt_v1_remote_release";
pub const FUTURE_RELEASE: &str = "foster_rt_v1_future_release";
...
pub const REF_LOAD_I8: &str = "foster_rt_v1_ref_load_i8";
pub const REF_LOAD_I32: &str = "foster_rt_v1_ref_load_i32";
pub const REF_LOAD_I64: &str = "foster_rt_v1_ref_load_i64";
pub const REF_LOAD_F64: &str = "foster_rt_v1_ref_load_f64";
pub const REF_LOAD_PTR: &str = "foster_rt_v1_ref_load_ptr";
pub const REF_STORE_I8: &str = "foster_rt_v1_ref_store_i8";
pub const REF_STORE_I32: &str = "foster_rt_v1_ref_store_i32";
pub const REF_STORE_I64: &str = "foster_rt_v1_ref_store_i64";
pub const REF_STORE_F64: &str = "foster_rt_v1_ref_store_f64";
pub const REF_STORE_PTR: &str = "foster_rt_v1_ref_store_ptr";

pub const WRITE_UNIT: &str = "foster_rt_v1_write_unit";
pub const WRITE_BOOL: &str = "foster_rt_v1_write_bool";
pub const WRITE_INT: &str = "foster_rt_v1_write_int";
pub const WRITE_FLOAT: &str = "foster_rt_v1_write_float";
pub const WRITE_CODE_POINT: &str = "foster_rt_v1_write_code_point";
pub const WRITE_BYTE: &str = "foster_rt_v1_write_byte";
pub const WRITE_STRING: &str = "foster_rt_v1_write_string";
pub const WRITE_OBJECT: &str = "foster_rt_v1_write_object";
pub const WRITE_ARGUMENTS: &str = "foster_rt_v1_write_arguments";
pub const WRITE_STRING_LIST: &str = "foster_rt_v1_write_string_list";
pub const WRITE_SEPARATOR: &str = "foster_rt_v1_write_separator";
pub const WRITE_NEWLINE: &str = "foster_rt_v1_write_newline";
...
pub const HOST_INITIALIZE: &str = "foster_rt_v1_host_initialize";
...
pub enum ResultOwnership {
    ...
    Owned,
    Transferred,
    /// Legacy text allocations have no retain/release protocol yet.
    LegacyAllocation,
}
...
runtime_functions! {
    ...
    WRITE_STRING_LIST: (Pointer Borrowed) -> U8 Scalar;
    WRITE_ARGUMENTS: (Pointer Borrowed) -> U8 Scalar;
    WRITE_SEPARATOR: () -> U8 Scalar;
    WRITE_NEWLINE: () -> U8 Scalar;
    STRING_CONSTANT: (I64 Value) -> Pointer Borrowed;
    ARGS_EXECUTABLE: (Pointer Borrowed) -> Pointer Borrowed;
    ARGS_VALUES: (Pointer Borrowed) -> Pointer Borrowed;
    STRING_LIST_EMPTY: (Pointer Borrowed) -> U8 Scalar;
    STRING_LIST_LENGTH: (Pointer Borrowed) -> I64 Scalar;
    STRING_LIST_GET: (Pointer Borrowed, I64 Value) -> Pointer Borrowed;
    STRING_LIST_HEAD: (Pointer Borrowed) -> Pointer Borrowed;
    STRING_EMPTY: (Pointer Borrowed) -> U8 Scalar;
    STRING_LENGTH: (Pointer Borrowed) -> I64 Scalar;
    STRING_HEAD: (Pointer Borrowed) -> U32 Scalar;
    STRING_REST: (Pointer Borrowed) -> Pointer LegacyAllocation;
    STRING_WHITESPACE: (Pointer Borrowed) -> U8 Scalar;
    STRING_CONCAT: (Pointer Borrowed, Pointer Borrowed) -> Pointer LegacyAllocation;
    STRING_BYTE_LENGTH: (Pointer Borrowed) -> I64 Scalar;
    STRING_COPY_BYTES: (Pointer Borrowed, Pointer Borrowed) -> U8 Scalar;
    STRING_FROM_UTF8: (Pointer Borrowed, I64 Value) -> Pointer LegacyAllocation;
    COPY_BYTES: (Pointer Borrowed, Pointer Borrowed, I64 Value) -> U8 Scalar;
    CODE_POINT_WHITESPACE: (U32 Value) -> U8 Scalar;
    CODE_POINT_STRING: (U32 Value) -> Pointer LegacyAllocation;
    ...
    FORMAT_FLOAT: (F64 Value) -> Pointer LegacyAllocation;
    ...
    HOST_STRING: (Pointer Borrowed, I64 Value, I64 Value) -> Pointer LegacyAllocation;
